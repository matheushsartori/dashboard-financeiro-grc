-- Script SQL para adicionar a coluna tipo_vinculo à tabela folha_pagamento
-- Execute este script no seu banco de dados PostgreSQL

ALTER TABLE "folha_pagamento" 
ADD COLUMN IF NOT EXISTS "tipo_vinculo" varchar(10);

-- Atualizar registros existentes com base em heurística (opcional)
